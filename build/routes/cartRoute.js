...
cartRouter.post("/", decodeIDToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (auth) {
        try {
            const cart = new cartModel_1.cartModel(req.body);
...
cartRouter.get("/", decodeIDToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (auth) {
        const cart = yield cartModel_1.cartModel.find({});
...
cartRouter.put("/item-amount/:id", (req, res) => {
    ...
    function updateScore() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // }
            try {
                const updatedProduct = yield cartModel_1.cartModel.findOneAndUpdate({ _id: req.params.id }, {
                    $set: {
                        "cartData.amountInCart": data.amountInCart,
                    },
                });
    ...
    function deleteItem() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const deletedUserItem = yield cartModel_1.cartModel.findByIdAndDelete(
